...
// Copia local de los fotografos para que la SPA funcione en GitHub Pages,
// donde no existe el backend /api/photographers.
...
// Carga los fotografos desde el backend (fallback: datos locales si no responde)
...
// Si el HTML conserva los placeholders (deploy estatico en GitHub Pages),
// se ignora Supabase y la app corre en modo demo con los usuarios de prueba.
const SUPABASE_CONFIGURED = !!(
  window.SUPABASE_URL &&
  window.SUPABASE_ANON_KEY &&
  String(window.SUPABASE_URL).indexOf('__SUPABASE_URL__') === -1 &&
  String(window.SUPABASE_ANON_KEY).indexOf('__SUPABASE_ANON_KEY__') === -1
);
